<div class="flex justify-center absolute right-12 top-4 z-50 rounded-lg">
    ...
    >
        ...
        >
            ...
            <a @click="setTheme('theme-dark')" :class="selectedTheme == 'theme-dark' ? 'bg-primary-600 text-on-primary-50' : ''" class="cursor-pointer flex items-center gap-1 w-full first-of-type:rounded-t-md last-of-type:rounded-b-md px-8 py-2 text-left text-base text-on-surface-500 hover:bg-primary-600 hover:text-on-primary-50 disabled:text-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <a @click="setTheme('auto')" :class="selectedTheme == 'auto' ? 'bg-primary-600 text-on-primary-50' : ''" class="cursor-pointer flex items-center gap-1 w-full first-of-type:rounded-t-md last-of-type:rounded-b-md px-8 py-2 text-left text-base text-on-surface-500 hover:bg-primary-600 hover:text-on-primary-50 disabled:text-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
