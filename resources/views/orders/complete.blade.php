...
@section('main')
    <section class="p-4 mt-6 px-2 py-2 lg:px-24">
        <div class="flex flex-col items-center justify-center">
            ...
            <h1 class="text-3xl font-bold mt-3 text-on-background">THANK YOU!</h1>

            <h2 class="text-on-background">Your order number is <span class="font-bold">{{ $order->code }}</span></h2>
            <p class="text-on-surface-500 mt-6 max-w-screen-sm text-center">
                ...
                comfirmtion email shortly to <span class="font-bold text-on-background">{{ $order->email }}</span>
            </p>
